...
import de.pfke.squeeze.core.refl.richCaseClass.mocks.{CaseClassMock0Args, CaseClassMock2Args_wMethods, CaseClassMock2Args_woMethods, CaseClassMock3Args_1Default}
