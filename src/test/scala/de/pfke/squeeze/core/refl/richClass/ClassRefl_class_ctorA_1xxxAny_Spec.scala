package de.pfke.squeeze.core.refl.richClass

import de.pfke.squeeze.core.refl.RichClass
import de.pfke.squeeze.core.refl.richClass.mocks.{CaseClassMock2Args_wMethods, ClassMock2Args_wOverloadedMethods}
