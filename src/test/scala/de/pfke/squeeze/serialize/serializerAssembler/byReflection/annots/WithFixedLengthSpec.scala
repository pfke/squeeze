...
import de.pfke.squeeze.testing.mocks.WithFixedLengthMock
  ...
  "testing serializer for WithFixedLengthMock type" when {
    checkThis[WithFixedLengthMock](
      code = s"""
                ...
                |  override def objectTypeInfo = GenericOps.getTypeInfo[de.pintono.tools.squeeze.core.mocks.WithFixedLengthMock]
                |
                |  override def read(
