...
import de.pfke.squeeze.testing.mocks.InjectCountOnSubMock
  ...
  "testing serializer for InjectCountOnSubMock type" when {
    checkThis[InjectCountOnSubMock](
      code = s"""
                ...
                |  override def objectTypeInfo = GenericOps.getTypeInfo[de.pintono.tools.squeeze.core.mocks.InjectCountOnSubMock]
                |
                |  override def read(
