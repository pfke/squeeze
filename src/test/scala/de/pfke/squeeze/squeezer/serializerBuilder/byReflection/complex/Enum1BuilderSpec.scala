package de.pfke.squeeze.squeezer.serializerBuilder.byReflection.complex
  ...
  "testing serializer for Enum1Mock type" when {
    checkThis[Enum1Mock](
      code = s"""
                ...
                |  override def objectTypeInfo = ReflHelper.generateTypeInfo[de.pintono.tools.squeeze.core.mocks.Enum1Mock.Enum1Mock]
                |
                |  override def read(
