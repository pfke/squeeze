package de.pfke.squeeze.squeezer.serializerBuilder.byReflection.complex.asBitfieldSpecs
    ...
    checkThis[asBitfield_mock_unaligned_blocks_multi](
      code =
        s"""
           ...
           |  override def objectTypeInfo = ReflHelper.generateTypeInfo[de.pintono.tools.squeeze.core.mocks.asBitfieldSpecs.asBitfield_mock_unaligned_blocks_multi]
           |
           |  override def read(
