  ...
  extends WordSpec
    ...
    "testing method 'filename'" when {
      ...
      "passing 'filename01'" should {
        ...
        "should return correct" in {
          tto.filename should be("filename01")
        }
      }
      ...
      "passing 'filename02.jpg'" should {
        ...
        "should return correct" in {
          tto.filename should be("filename02.jpg")
        }
      }
      ...
      "passing '/jklsdfjkld/jlk/filename03'" should {
        ...
        "should return correct" in {
          tto.filename should be("filename03")
        }
      }
      ...
      "passing '/jklsdfjkld/jlk/filename04.klj'" should {
        ...
        "should return correct" in {
          tto.filename should be("filename04.klj")
        }
      }
      ...
      "passing 'jklsdfjkld/jlk/filename05.klj'" should {
        ...
        "should return correct" in {
          tto.filename should be("filename05.klj")
        }
      }
    }
  }
