...
import de.pintono.grind.refl.core.MethodParameter
...
class CaseClassRefl_class_applyMethodParameter_Spec
  extends WordSpec
    with Matchers {
  ...
  "testing case class: 'CaseClassMock2Args_wOverloadedMethods'" when {
    lazy val tto = CaseClassRefl[CaseClassMock2Args_wOverloadedMethods]
